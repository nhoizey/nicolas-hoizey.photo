...
module.exports = {
  default: {
    resizedImageUrl: (src, width) => `.netlify/images?url=${src}&w=${width}`,
    // resizedImageUrl: (src, width) => `https://res.cloudinary.com/nho/image/fetch/q_auto,f_auto/w_auto:breakpoints_360_1600_20_10:${width}/${src}`,
