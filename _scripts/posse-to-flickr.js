...
const posseToFlickr = async () => {
	...
	if (tagsForGroups.has("mavic-pro-2")) {
		groups.add("2899589@N22").add("4430068@N21").add("2915750@N22").add("3917295@N24").add("3738453@N24").add("3103751@N22").add("3159509@N21").add("3207388@N22").add("2882936@N25").add("2785426@N22").add("2873408@N25").add("2199141@N21").add("3391586@N20").add("4430068@N21").add("4510878@N24").add("4522479@N20").add("3049151@N20");
	}
